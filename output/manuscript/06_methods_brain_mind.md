...
of 170,000 Kenyon cells per hemisphere. Each Kenyon cell
samples a small fixed fan-in of glomeruli through a seed-fixed sparse
projection, and a $k$-Winner-Take-All rule keeps the
6,800 most-driven cells active across both hemispheres
($\rho = 0.02$ of the whole-brain 170,000×2
...
system. It maintains a 32-dimensional belief state,
...
policy horizon is 10 steps, and candidate expansion is

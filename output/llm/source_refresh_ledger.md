...
| `@wallberg2019hav31` | `10.1186/s12864-019-5642-0` | scholarship_anchor | open_repository_not_wired | `manuscript/01_scholarship_and_related_work.md`, `manuscript/03_materials_and_source_provenance.md` | `output/figures/beestack_scholarship_evidence_matrix.png` |
...
| `ncbi_amel_hav31` | reference_genome | `10.1186/s12864-019-5642-0` | BeeBrain | no | No genome-fetch stage in empirical pipeline. |

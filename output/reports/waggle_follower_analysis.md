...
This report covers the curated Hadjitofi-Webb Figshare waggle-following source and its integration into BeeBrain/BeeSwarm waggle decoding.

- Dataset status: `parsed`
- Tracks: `59`
- Feature rows: `11263`
- Binned rows: `407`
- Model-error rows: `56870`
- Follower angle/midpoint correlation: `0.334`
- Both-antennae decoding error: `60.178` deg
- No-antennae decoding error: `80.000` deg
- Decoding improvement fraction: `0.248`
- Confidence score: `0.289`

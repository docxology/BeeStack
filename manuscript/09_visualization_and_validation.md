...
{{METHODS_EVIDENCE_LINK_COUNT}} manuscript evidence links, and a manuscript
figure index with {{MANUSCRIPT_FIGURE_INDEX_COUNT}} artifact rows. The index maps every cited figure or visual artifact to
